        ...
        while(p < bfCode.length) {
            ...
            switch (c) {
                case '>':
                {
                    ...
                    functionBody.push(0x20, 0x00, 0x41, ...encodeSignedLeb128FromInt32(counter * 4), 0x6a, 0x21, 0x00); break;
                }
                // local.get $pointer
                // i32.const 4
                // i32.add
                ...
                case '<':
                {
                    ...
                    functionBody.push(0x20, 0x00, 0x41, ...encodeSignedLeb128FromInt32(counter * 4), 0x6b, 0x21, 0x00); break;
                }
                // local.get $pointer
                // i32.const 4
                // i32.sub
                ...
                case '+':
                {
                    ...
                    functionBody.push(0x20, 0x00, 0x20, 0x00, 0x28, 0x02, 0x00, 0x41, ...encodeSignedLeb128FromInt32(counter), 0x6a, 0x36, 0x02, 0x00); break;
                }
                // local.get $pointer
                // local.get $pointer
                // i32.load
                ...
                case '-':
                {
                    ...
                    functionBody.push(0x20, 0x00, 0x20, 0x00, 0x28, 0x02, 0x00, 0x41,  ...encodeSignedLeb128FromInt32(counter), 0x6b, 0x36, 0x02, 0x00); break;
                }
                // local.get $pointer
                // local.get $pointer
                // i32.load
